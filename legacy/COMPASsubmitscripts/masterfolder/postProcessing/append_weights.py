...
if __name__ == "__main__":
    # If you run this script from a terminal use the global parameters defined at the top
    # Otherwise call it from your own script with the settings there
    main(data_dir = Dir, Stroopwafel_name = SW_name, Raw_COMPAS_name = Raw_name, Weights_COMPAS_name = New_name)
