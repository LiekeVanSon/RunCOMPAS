...
def find_detection_rate(path, dco_type="BBH", merger_output_filename=None, weight_column=None,
    ...
    """
        ...
        Args:
            ...
            dco_type               --> [string] Which DCO type to calculate rates for: one of ["all", "BBH", "BHNS", "BNS", "WDWD"]
...
def parse_cli_args():
    ...
    parser.add_argument("--dco_type", dest='dco_type',
                        help="Which DCO type you used to calculate rates, one of: ['all', 'BBH', 'BHNS', 'BNS', 'WDWD'] ",
...
def main():
    ...
    print(f'Running cosmic integration with remove_pessimistic_CEE = {args.remove_pessimistic_CEE}, and remove_RLOF_after_CEE = {args.remove_RLOF_after_CEE}' ) 
    #####################################
